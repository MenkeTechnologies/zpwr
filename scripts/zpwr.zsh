...
() {
    ...
    ZPWR_VERBS[emacsrecent]='zpwrEmacsRecent=emacs edit most recent vim files'
    ZPWR_VERBS[emacsrecentsudo]='zpwrSudoEmacsRecent=emacs edit most vim recent files'
    ...
    ZPWR_VERBS[gitreposdirtyexec]='zpwrForAllGitDirsDirty=run cmd in all git dirs'
    ZPWR_VERBS[gitreposdirtyrefreshexec]='zpwrForAllGitDirsRefreshDirty=refresh cache and run cmd in all git dirs'
    ...
    ZPWR_VERBS[vimrecent]='zpwrVimRecent=choose most recent vim files'
    ZPWR_VERBS[vimrecentsudo]='zpwrSudoVimRecent=sudo chooose most vim recent files'
