...
ZPWR_VERBS[emacsfindsearch]='findFzfEditNoZLEEmacs=emacs find drive for file'
ZPWR_VERBS[emacsfindsearchedit]='findFzfNoZLEEmacs=emacs edit find drive for file'
...
ZPWR_VERBS[locatesearchaccept]='locateFzfNoZLEC=accept locate drive for file'
