...
ZPWR_VERBS[drivesearchaccept]='locateFzfNoZLE=accept search drive for file'
ZPWR_VERBS[drivesearchedit]='locateFzfEditNoZLE=edit search drive for file'
...
ZPWR_VERBS[emacsrecentsudo]='sudoEmacsRecent=emac edit most vim recent files'
...
ZPWR_VERBS[ctags]='zpwrCtags=view zpwr ctags tags'
ZPWR_VERBS[gtags]='zpwrGtags=view zpwr GNU global tags'
