...
ZPWR_VERBS[gitfordirmaster]='zfgdm=run git wipe to master branch in git dirs in $PWD'
ZPWR_VERBS[gitzfordirdevelop]='zd=z $1 and run git wipe to develop branch in git dirs in $PWD'
ZPWR_VERBS[gitzfordirmaster]='zm=z $1 and run git wipe to master branch in git dirs in $PWD'
