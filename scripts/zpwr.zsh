...
ZPWR_VERBS[gitedittag]='zpwrEditTag=print tag update to BUFFER'
...
ZPWR_VERBS[zshplugincount]='echo $#plugins=total number of zsh plugins in \$ZPWR'
ZPWR_VERBS[zshpluginlist]='echo $plugins=zpwrVimPluginList=total list of zsh plugins in \$ZPWR'
