...
ZPWR_VERBS[travis]='trav-git=open travis projet in browser'
ZPWR_VERBS[travisbuild]='trav-git-build=open travis project in browser'
ZPWR_VERBS[travisbranch]='trav-git-br=open travis branches in browser'
ZPWR_VERBS[travispr]='trav-git-pr=open travis PRs in browser'
