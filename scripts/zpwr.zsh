...
ZPWR_VERBS[findsearchaccept]='findFzfNoZLE=accept find drive for file'
ZPWR_VERBS[findsearchedit]='findFzfEditNoZLE=edit find drive for file'
ZPWR_VERBS[locatesearchaccept]='locateFzfNoZLE=accept locate drive for file'
ZPWR_VERBS[locatesearchedit]='locateFzfEditNoZLE=edit locate drive for file'
