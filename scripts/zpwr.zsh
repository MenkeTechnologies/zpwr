...
() {
    ...
    ZPWR_VERBS[zpwrCloneToForked]='zpwrCloneToForked=clone \$ZPWR_REPO_NAME to \$FORKED_DIR'
    ...
    ZPWR_VERBS[regengit]='zsh-git-repo-regenAllGitRepos=regen list of all git repos to \$ZPWR_ALL_GIT_DIRS'
