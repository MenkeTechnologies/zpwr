...
- ``` i  <Plug>delimitMateS-Tab * <SNR>59_TriggerAbb()."\<C-R>=delimitMate#JumpAny()\<CR>" ```
- ``` i  <Plug>delimitMateSpace * <SNR>59_TriggerAbb()."\<C-R>=delimitMate#ExpandSpace()\<CR>" ```
- ``` i  <Plug>delimitMateCR * <SNR>59_TriggerAbb()."\<C-R>=delimitMate#ExpandReturn()\<CR>" ```
- ``` i  <Plug>delimitMateS-BS * delimitMate#WithinEmptyPair() ? "\<Del>" : "\<S-BS>" ```
- ``` i  <Plug>delimitMateBS * <C-R>=delimitMate#BS()<CR> ```
- ``` i  <Plug>delimitMate` * <SNR>59_TriggerAbb()."<C-R>=delimitMate#QuoteDelim(\"\\\`\")<CR>" ```
- ``` i  <Plug>delimitMate' * <SNR>59_TriggerAbb()."<C-R>=delimitMate#QuoteDelim(\"\\\'\")<CR>" ```
- ``` i  <Plug>delimitMate" * <SNR>59_TriggerAbb()."<C-R>=delimitMate#QuoteDelim(\"\\\"\")<CR>" ```
- ``` i  <Plug>delimitMate] * <SNR>59_TriggerAbb().delimitMate#JumpOut("\]") ```
- ``` i  <Plug>delimitMate} * <SNR>59_TriggerAbb().delimitMate#JumpOut("\}") ```
- ``` i  <Plug>delimitMate) * <SNR>59_TriggerAbb().delimitMate#JumpOut("\)") ```
- ``` i  <Plug>delimitMate[ * <SNR>59_TriggerAbb().delimitMate#ParenDelim("]") ```
- ``` i  <Plug>delimitMate{ * <SNR>59_TriggerAbb().delimitMate#ParenDelim("}") ```
- ``` i  <Plug>delimitMate( * <SNR>59_TriggerAbb().delimitMate#ParenDelim(")") ```
...
- ``` i  <C-X><C-A>  * <C-A> ```
- ``` i  <C-X>       * <C-R>=<SNR>35_ManualCompletionEnter()<CR> ```
...
- ``` n  <p          & :<C-U>call <SNR>140_putline(v:count1 . ']p', 'Below')<CR><'] ```
- ``` n  <P          & :<C-U>call <SNR>140_putline(v:count1 . '[p', 'Above')<CR><'] ```
- ``` n  =p          & :<C-U>call <SNR>140_putline(v:count1 . ']p', 'Below')<CR>='] ```
- ``` n  =P          & :<C-U>call <SNR>140_putline(v:count1 . '[p', 'Above')<CR>='] ```
- ``` n  >p          & :<C-U>call <SNR>140_putline(v:count1 . ']p', 'Below')<CR>>'] ```
- ``` n  >P          & :<C-U>call <SNR>140_putline(v:count1 . '[p', 'Above')<CR>>'] ```
...
- ``` n  <Plug>unimpairedPutAbove * :call <SNR>140_putline('[p', 'Above')<CR> ```
- ``` n  <Plug>(unimpaired-toggle)p & :<C-U>call <SNR>140_SetupPaste()<CR>0C ```
- ``` n  <Plug>(unimpaired-disable)p & :<C-U>call <SNR>140_SetupPaste()<CR>o ```
- ``` n  <Plug>(unimpaired-enable)p & :<C-U>call <SNR>140_SetupPaste()<CR>O ```
- ``` n  <Plug>(unimpaired-paste) & :<C-U>call <SNR>140_SetupPaste()<CR> ```
- ``` n  <Plug>unimpairedPaste * :call <SNR>140_SetupPaste()<CR> ```
- ``` n  <Plug>(unimpaired-toggle)+ & :<C-U>set <C-R>=<SNR>140_CursorOptions()<CR><CR> ```
...
- ``` n  <Plug>(unimpaired-toggle)x & :<C-U>set <C-R>=<SNR>140_CursorOptions()<CR><CR> ```
...
- ``` n  <Plug>(unimpaired-toggle)w & :<C-U>setlocal <C-R>=<SNR>140_Toggle("wrap")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)w & :<C-U>setlocal nowrap<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)w & :<C-U>setlocal wrap<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)s & :<C-U>setlocal <C-R>=<SNR>140_Toggle("spell")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)s & :<C-U>setlocal nospell<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)s & :<C-U>setlocal spell<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)r & :<C-U>setlocal <C-R>=<SNR>140_Toggle("relativenumber")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)r & :<C-U>setlocal norelativenumber<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)r & :<C-U>setlocal relativenumber<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)n & :<C-U>setlocal <C-R>=<SNR>140_Toggle("number")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)n & :<C-U>setlocal nonumber<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)n & :<C-U>setlocal number<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)l & :<C-U>setlocal <C-R>=<SNR>140_Toggle("list")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)l & :<C-U>setlocal nolist<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)l & :<C-U>setlocal list<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)i & :<C-U>set <C-R>=<SNR>140_Toggle("ignorecase")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)i & :<C-U>set noignorecase<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)i & :<C-U>set ignorecase<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)h & :<C-U>set <C-R>=<SNR>140_Toggle("hlsearch")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)h & :<C-U>set nohlsearch<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)h & :<C-U>set hlsearch<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
...
- ``` n  <Plug>(unimpaired-toggle)| & :<C-U>setlocal <C-R>=<SNR>140_Toggle("cursorcolumn")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)| & :<C-U>setlocal nocursorcolumn<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)| & :<C-U>setlocal cursorcolumn<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)u & :<C-U>setlocal <C-R>=<SNR>140_Toggle("cursorcolumn")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)u & :<C-U>setlocal nocursorcolumn<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)u & :<C-U>setlocal cursorcolumn<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)_ & :<C-U>setlocal <C-R>=<SNR>140_Toggle("cursorline")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)_ & :<C-U>setlocal nocursorline<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)_ & :<C-U>setlocal cursorline<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)- & :<C-U>setlocal <C-R>=<SNR>140_Toggle("cursorline")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)- & :<C-U>setlocal nocursorline<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)- & :<C-U>setlocal cursorline<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-toggle)c & :<C-U>setlocal <C-R>=<SNR>140_Toggle("cursorline")<CR><CR> ```
- ``` n  <Plug>(unimpaired-disable)c & :<C-U>setlocal nocursorline<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
- ``` n  <Plug>(unimpaired-enable)c & :<C-U>setlocal cursorline<C-R>=<SNR>140_StatuslineRefresh()<CR><CR> ```
...
- ``` n  <Plug>unimpairedMoveDown * :<C-U>call <SNR>140_Move('+',v:count1,'Down')<CR> ```
- ``` n  <Plug>unimpairedMoveUp * :<C-U>call <SNR>140_Move('--',v:count1,'Up')<CR> ```
- ``` n  <Plug>unimpairedBlankDown * :<C-U>exe <SNR>140_BlankDown()<CR> ```
- ``` n  <Plug>unimpairedBlankUp * :<C-U>exe <SNR>140_BlankUp()<CR> ```
- ``` n  <Plug>unimpairedContextNext * :<C-U>call <SNR>140_Context(0)<CR> ```
- ``` n  <Plug>unimpairedContextPrevious * :<C-U>call <SNR>140_Context(1)<CR> ```
- ``` n  <Plug>unimpairedDirectoryPrevious * :<C-U>execute <SNR>140_PreviousFileEntry(v:count1)<CR> ```
...
- ``` n  <Plug>Yssurround * '^'.v:count1.<SNR>139_opfunc('setup').'g_' ```
- ``` n  <Plug>CSurround * :<C-U>call <SNR>139_changesurround(1)<CR> ```
- ``` n  <Plug>Csurround * :<C-U>call <SNR>139_changesurround()<CR> ```
- ``` n  <Plug>Dsurround * :<C-U>call <SNR>139_dosurround(<SNR>139_inputtarget())<CR> ```
...
- ``` n  <Plug>Sneak_, * :<C-U>call <SNR>137_rpt('', 1)<CR> ```
- ``` n  <Plug>Sneak_; * :<C-U>call <SNR>137_rpt('', 0)<CR> ```
- ``` n  <Plug>Sneak_S * :<C-U>call sneak#wrap('', 2, 1, 2, 1)<CR> ```
- ``` n  <Plug>Sneak_s * :<C-U>call sneak#wrap('', 2, 0, 2, 1)<CR> ```
- ``` n  <Plug>(sexp_capture_next_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#stackop', 'n', 1, 1) | call <SNR>134_repeat_set("\<Plug>(sexp_capture_next_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_capture_prev_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#stackop', 'n', 0, 1) | call <SNR>134_repeat_set("\<Plug>(sexp_capture_prev_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_emit_tail_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#stackop', 'n', 1, 0) | call <SNR>134_repeat_set("\<Plug>(sexp_emit_tail_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_emit_head_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#stackop', 'n', 0, 0) | call <SNR>134_repeat_set("\<Plug>(sexp_emit_head_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_swap_element_forward) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#swap_element', 'n', 1, 0) | call <SNR>134_repeat_set("\<Plug>(sexp_swap_element_forward)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_swap_element_backward) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#swap_element', 'n', 0, 0) | call <SNR>134_repeat_set("\<Plug>(sexp_swap_element_backward)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_swap_list_forward) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#swap_element', 'n', 1, 1) | call <SNR>134_repeat_set("\<Plug>(sexp_swap_list_forward)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_swap_list_backward) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#swap_element', 'n', 0, 1) | call <SNR>134_repeat_set("\<Plug>(sexp_swap_list_backward)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_splice_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#splice_list(b:sexp_count) | call <SNR>134_repeat_set("\<Plug>(sexp_splice_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_convolute) * :<C-U>let b:sexp_count = v:count | call sexp#convolute(b:sexp_count, 'n') | call <SNR>134_repeat_set("\<Plug>(sexp_convolute)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_raise_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#raise', 'n', 'sexp#select_current_element', 'n', 1) | call <SNR>134_repeat_set("\<Plug>(sexp_raise_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_raise_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#docount(b:sexp_count, 'sexp#raise', 'n', 'sexp#select_current_list', 'n', 0, 0) | call <SNR>134_repeat_set("\<Plug>(sexp_raise_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_insert_at_list_tail) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#insert_at_list_terminal(1) | call <SNR>134_repeat_set("\<Plug>(sexp_insert_at_list_tail)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_insert_at_list_head) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#insert_at_list_terminal(0) | call <SNR>134_repeat_set("\<Plug>(sexp_insert_at_list_head)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_curly_tail_wrap_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('e', '{', '}', 1, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_curly_tail_wrap_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_curly_head_wrap_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('e', '{', '}', 0, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_curly_head_wrap_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_square_tail_wrap_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('e', '[', ']', 1, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_square_tail_wrap_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_square_head_wrap_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('e', '[', ']', 0, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_square_head_wrap_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_round_tail_wrap_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('e', '(', ')', 1, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_round_tail_wrap_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_round_head_wrap_element) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('e', '(', ')', 0, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_round_head_wrap_element)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_curly_tail_wrap_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('f', '{', '}', 1, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_curly_tail_wrap_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_curly_head_wrap_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('f', '{', '}', 0, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_curly_head_wrap_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_square_tail_wrap_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('f', '[', ']', 1, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_square_tail_wrap_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_square_head_wrap_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('f', '[', ']', 0, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_square_head_wrap_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_round_tail_wrap_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('f', '(', ')', 1, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_round_tail_wrap_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_round_head_wrap_list) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#wrap('f', '(', ')', 0, g:sexp_insert_after_wrap) | call <SNR>134_repeat_set("\<Plug>(sexp_round_head_wrap_list)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_indent_top) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#indent(1, b:sexp_count) | call <SNR>134_repeat_set("\<Plug>(sexp_indent_top)", b:sexp_count)<CR> ```
- ``` n  <Plug>(sexp_indent) * :<C-U>let b:sexp_count = v:count | execute "normal! m`" | call sexp#indent(0, b:sexp_count) | call <SNR>134_repeat_set("\<Plug>(sexp_indent)", b:sexp_count)<CR> ```
...
- ``` n  <Plug>(abolish-coerce-word) * <SNR>110_coerce(nr2char(getchar())).'iw' ```
- ``` n  <Plug>(abolish-coerce) * <SNR>110_coerce(nr2char(getchar())) ```
...
- ```    <Plug>unimpairedMoveSelectionDown * :<C-U>call <SNR>140_MoveSelectionDown(v:count1)<CR> ```
- ```    <Plug>unimpairedMoveSelectionUp * :<C-U>call <SNR>140_MoveSelectionUp(v:count1)<CR> ```
- ``` x  <Plug>unimpairedContextNext * :<C-U>exe 'normal! gv'|call <SNR>140_Context(0)<CR> ```
- ``` x  <Plug>unimpairedContextPrevious * :<C-U>exe 'normal! gv'|call <SNR>140_Context(1)<CR> ```
- ``` v  <Plug>VgSurround * :<C-U>call <SNR>139_opfunc(visualmode(),visualmode() ==# 'V' ? 0 : 1)<CR> ```
- ``` v  <Plug>VSurround * :<C-U>call <SNR>139_opfunc(visualmode(),visualmode() ==# 'V' ? 1 : 0)<CR> ```
...
- ``` x  <Plug>Sneak_, * :<C-U>call <SNR>137_rpt(visualmode(), 1)<CR> ```
- ``` x  <Plug>Sneak_; * :<C-U>call <SNR>137_rpt(visualmode(), 0)<CR> ```
...
- ```    <Plug>(asterisk-g*) * asterisk#do(mode(1), {'direction' : 1, 'do_jump' : 1, 'is_whole' : 0}) ```
- ```    <Plug>(asterisk-*) * asterisk#do(mode(1), {'direction' : 1, 'do_jump' : 1, 'is_whole' : 1}) ```
- ``` v  <Plug>(abolish-coerce) * <SNR>110_coerce(nr2char(getchar())) ```
...
- ``` c  <C-T>       * <SNR>129_transpose() ```
- ``` c  <C-U>       * <SNR>129_ctrl_u() ```
- ``` c  <C-X><C-A>  * <C-A> ```
