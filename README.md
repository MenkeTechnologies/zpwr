...
YCM (vim ccode completion engine) will source this file (`autocmd filetype * set tags+=~/tags` includes `~/tags`), while providing completion so tab completion on all zpwr env vars should work.
