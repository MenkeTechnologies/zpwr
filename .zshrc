...
zstyle ':completion:*' group-order commands aliases global-aliases suffix-aliases functions builtins  reserverd-words parameters options argument-rest globbed-files files fasd-file fasd zdir last-line last-ten
