...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(yasnippet yasnippet-snippets
           company-ycmd real-auto-save fzf)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(darkburn dracula)
