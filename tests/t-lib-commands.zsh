...
@test 'zpwrCommandExists command returns 0' {
    run zpwrCommandExists command
    assert $state equals 0
}
...
@test 'zpwrCommandExists strings returns 0' {
    run zpwrCommandExists strings
    assert $state equals 0
}
...
# Job / shell helpers
#--------------------------------------------------------------
@test 'zpwrCommandExists jobs returns 0' {
    run zpwrCommandExists jobs
    assert $state equals 0
}

@test 'zpwrCommandExists wait returns 0' {
    run zpwrCommandExists wait
    assert $state equals 0
}

@test 'zpwrCommandExists ulimit returns 0' {
    run zpwrCommandExists ulimit
    assert $state equals 0
}

@test 'zpwrCommandExists umask returns 0' {
    run zpwrCommandExists umask
    assert $state equals 0
}
