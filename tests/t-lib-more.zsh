...
@test 'zpwrCommandExists sudo returns 0' {
    run zpwrCommandExists sudo
    assert $state equals 0
}

@test 'zpwrCommandExists openssl returns 0' {
    run zpwrCommandExists openssl
    assert $state equals 0
}
...
#--------------------------------------------------------------
# Editors / pagers (CI installs vim)
#--------------------------------------------------------------
...
@test 'zpwrCommandExists more returns 0' {
    run zpwrCommandExists more
    assert $state equals 0
}

@test 'zpwrCommandExists less returns 0' {
    run zpwrCommandExists less
    assert $state equals 0
}
