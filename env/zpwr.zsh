...
() {
    ...
    ZPWR_VERBS[attach]='$ZPWR_ZTMUX attach-session=attach to tmux session'
    ...
    ZPWR_VERBS[envaccept]='zpwrFzfEnvVerbAccept=accept from arb --fzf env'
    ZPWR_VERBS[envedit]='zpwrFzfEnvVerbEdit=edit from arb --fzf env'
    ...
    ZPWR_VERBS[execglobparallel]='zpwrExecGlobParallel=parallel exec on globbed files'
    ...
    ZPWR_VERBS[forgitadd]='forgit::add=forgit interactive add'
    ZPWR_VERBS[forgitclean]='forgit::clean=forgit interactive clean'
    ZPWR_VERBS[forgitdiff]='forgit::diff=forgit interactive diff'
    ZPWR_VERBS[forgitignore]='forgit::ignore=forgit interactive ignore'
    ZPWR_VERBS[forgitignoreclean]='forgit::ignore::clean=forgit interactive ignore clean'
    ZPWR_VERBS[forgitignoreget]='forgit::ignore::get=forgit interactive ignore get'
    ZPWR_VERBS[forgitignorelist]='forgit::ignore::list=forgit interactive ignore list'
    ZPWR_VERBS[forgitignoreupdate]='forgit::ignore::update=forgit interactive ignoreupdate'
    ZPWR_VERBS[forgitinfo]='forgit::info=forgit interactive info'
    ZPWR_VERBS[forgitlog]='forgit::log=forgit interactive log'
    ZPWR_VERBS[forgitreset]='forgit::reset::head=forgit interactive reset'
    ZPWR_VERBS[forgitrestore]='forgit::restore=forgit interactive restore'
    ZPWR_VERBS[forgitstash]='forgit::stash::show=forgit interactive stash'
    ZPWR_VERBS[forgitwarn]='forgit::warn=forgit interactive warn'
    ...
    ZPWR_VERBS[gitemail]='zpwrChangeGitEmail=change email with git filter-branch'
    ZPWR_VERBS[gitcemail]='zpwrChangeGitCommitterEmail=change committer email with git filter-branch'
    ZPWR_VERBS[gitaemail]='zpwrChangeGitAuthorEmail=change author email with git filter-branch'
    ...
    ZPWR_VERBS[gitcommits]='zpwrCommits=search git commits via vim :Commits'
    ...
    ZPWR_VERBS[grep]='zpwrAgIntoFzf=grep through pwd with ag into arb --fzf'
    ...
    ZPWR_VERBS[killmux]='$ZPWR_ZTMUX kill-server=kill tmux server'
    ...
    ZPWR_VERBS[man]='fm=arb --fzf through man pages'
    ...
    ZPWR_VERBS[subcommandsfzf]='zpwrVerbsFZF=arb --fzf the subcommands for zpwr <tab>'
    ...
    ZPWR_VERBS[layoutload]='zpwrTmuxLoad=restore a saved tmux layout'
    ...
    ZPWR_VERBS[verbsfzf]='zpwrVerbsFZF=arb --fzf the subcommands for zpwr <tab>'
